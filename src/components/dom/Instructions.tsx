  ...
  return (
    ...
    >
      ...
      <div className='tracking-wider'>
        ...
        <span style={{ color: 'rgb(95, 170, 232)', fontWeight: 'bold', }}> @/pages/index </span>
        <br />
        ...
        <span style={{ color: 'rgb(95, 170, 232)', fontWeight: 'bold', }}> @/pages/box </span>
        <br />
        Step 4 -{' '}
        <span style={{ color: 'rgb(84, 90, 114)' }}>update header:</span>
        <span style={{ color: 'rgb(95, 170, 232)', fontWeight: 'bold', }}> @/config </span>
        <br />
