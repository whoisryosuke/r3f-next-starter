import { BufferGeometry, PlaneGeometry, BufferAttribute, Box3, ShaderChunk } from 'three';
    ...
    computeGeometry() {
        ...
        Object.keys(attr).forEach((name) => {
            if (attr[name]) {
                ...
                this.setAttribute(name, new BufferAttribute(new Float32Array(cc * vcc * size), size));
            }
        });
...
export { Font, TextGeometry, extendMSDFMaterial };
